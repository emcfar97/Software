...
GENERAL = {
    ...
    'erect_nipples':'covered_erect_nipples|erect_nipples_under_clothes',
...
ARTIST = {
    ...
    'aikokusha_(agobitch_nee_san)': ['agovitch', 0],
    'akchu': ['akchu', 0],
    'ringoya_(alp)': ['alp', 0],
    'aomori': ['aomori', 1],
    ...
    'nayuru': ['crescentia', 1],
    'robutts': ['cutesexyrobutts', 1],
    'ドウモウ_doumou': ['doumou', 0],
    'uejini': ['gashi-gashi', 0],
    ...
    'nekofondue': ['soduki', -1],
    'splash_brush': ['splashbrush', 1],
    'splashbrush': ['splashbrush', 1],
    'stormcow': ['stormcow', 1],
    'sue': ['suertee34', -1],
    'arctic char': ['tabata_hisayuki', 0],
    'arcticchar': ['tabata_hisayuki', 0],
